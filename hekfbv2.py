...
# -*- coding: utf-8 -*-
# coded by Rival-ID
# reedit & translate to indonesia by muslim Ahmed
import os
import re 
import time
import json
...
result = 0
def masuk():
        print('\n\n\t\t≺ \033[1;36mLOGIN FACEBOOK PAKEK COOKIES TOLOL\033[0m ≻\n\n')
        print("Gak Bisa? Wa Gw Tolol 085264278359")
        try:
                cek = open("cookies").read()
        except FileNotFoundError:
                cek = input("[\033[1;32m>\033[0m Masukan Cookie Facebook Lu: ")
        cek = {"cookie":cek}
...
if __name__ == '__main__':
        try:
                ...
                os.system("clear")
                logo = """  
\033[31;1m  _______  __    __    ______  _______  __  ___ 
\033[31;1m |   ____||  |  |  |  /      ||   ____||  |/  / 
\033[31;1m |  |__   |  |  |  | |  ,----'|  |__   |  '  /  
\033[37;1m |   __|  |  |  |  | |  |     |   __|  |    <   
\033[37;1m |  |     |  `--'  | |  `----.|  |____ |  .  \  
\033[37;1m |__|      \______/   \______||_______||__|\__\ 
                                               
\033[1;33m╔═════════════════════YOU══════════════════════╗
\033[1;33m║\033[33;1m* \033[32;1mGithub \033[1;93m: \033[32;1mhttps://github.com/Rival-DI \033[1;93m                   
\033[1;33m║\033[33;1m* \033[32;1mCodeBy \033[1;93m: \033[32;1m\033[4mRival-DI\033[0m \033[1;93m                  
\033[1;33m║\033[33;1m* \033[32;1mWa\033[1;93m     : \033[32;1m\033[4m+6285264278359\033[0m\033[1;93m       
\033[1;33m╚═════════════════════YOU══════════════════════╝
"""
                print(logo)
                print('\033[1;33m=========================')
                print('\033[1;31m[\033[1;33m1\033[1;31m] \033[32;1mDaftar Teman')
                print('\033[1;31m[\033[1;33m2\033[1;31m] \033[32;1mDari Like ')
                ('\033[1;31m[\033[1;33m3\033[1;31m] \033[32;1mDari Pencarian nama')
                print('\033[1;31m[\033[1;33m4\033[1;31m] \033[32;1mDari Group ')
                print('\033[1;31m[\033[1;33m5\033[1;31m] \033[32;1mDari Pertemanan Teman')
                ('\033[1;31m[\033[1;33m6\033[1;31m] \033[32;1mLihat hasil')
                print('\033[0m\n')
                print()
                tanya = input('➛ ')
                if tanya =="":
                        ...
                        print("# \033[32;1mHanya bisa 100 id yg di dapatkan ")
                        grab = input("# ID group : ")
                ...
                if check != 0 or result != 0:
                        ...
                        exit("# Terimakasih Ya Tod Telah Gunakan Tools Ini, Jangan Lupa Coli 3× Sehari Ok!!")
                else:
                        print("\n# Selesai")
                        exit("# tidak ada hasil")
